...
export default function EditDataForm(props) {
  ...
  return (
    <>
      <Modal opened={props.isOpen} withCloseButton onClose={handleCloseModal} size="md" radius="md" title="Edit Product">
        <form onSubmit={form.onSubmit(() => mutate())}>
          <TextInput withAsterisk label="Title" placeholder="Input your title product" {...form.getInputProps("title")} />
